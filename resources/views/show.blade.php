<html lang="en">
    ...
    <body>
        <section
            class="w-full px-3 antialiased bg-indigo-600 lg:px-6 h-screen"
        ...
        >
            <div class="mx-auto max-w-7xl">
                    ...
                    >
                        ...
                        >
                            <span
                                ...
                                ><span class="">Linky</span
                                ><span
                                    class="text-indigo-300"
                                    data-primary="indigo-300"
                                    >.</span
                                ></span
                            >
                        </a>
                        <div
                            class="fixed top-0 left-0 z-40 items-center w-full h-full p-3 text-xl bg-gray-900 bg-opacity-50 md:text-sm lg:text-base md:w-3/4 md:bg-transparent md:p-0 md:relative md:flex hidden"
                ...
                <div class="container py-32 mx-auto text-center sm:px-4">
                    ...
                    >
                    @csrf
                    <div class="text-sm mbb-10 text-indigo-300 pt-2 "
                    data-primary="indigo-600"
                    >
                        Right Click To Copy Link
                    </div>
                        <span class="relative top-0 right-0 block">
                            <a href="http://localhost:80/{{$short_url}}"
                                type="submit"
